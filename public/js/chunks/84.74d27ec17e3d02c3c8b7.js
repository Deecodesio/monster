...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/admin/roles/create_staff.vue?vue&type=script&lang=js":
/*!*********************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/src/views/admin/roles/create_staff.vue?vue&type=script&lang=js ***!
  \*********************************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    this.$http.get('/admin/get_roles').then(function (res) {
      _this.roles = res.data;
    });
    if (this.$route.params.id) {
      this.$http.get('/admin/edit_admin/' + this.$route.params.id).then(function (res) {
        _this.$http.get('/admin/get_role_id/' + res.data.message.role_id).then(function (res) {
  ...
  methods: {
    ...
    onChange: function onChange(event) {
      var _this2 = this;
      console.log(event);
      this.$http.get('/admin/get_role_id/' + event).then(function (res) {
    ...
    add_banner: function add_banner() {
      var _this3 = this;
      ...
      this.$http.post("/admin/add_admin", this.banner).then(function (response) {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/admin/roles/create_staff.vue?vue&type=template&id=61540a39":
/*!*************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/src/views/admin/roles/create_staff.vue?vue&type=template&id=61540a39 ***!
  \*************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
        ...
        [
          _c(
            ...
            [
                    ...
                    [
                      _c("v-select", {
                        attrs: {
                          ...
                          placeholder: _vm.$t("select") + " " + _vm.$t("role"),
                        ...
                        model: {
                          value: _vm.banner.role_id,
                          callback: function ($$v) {
                            _vm.$set(_vm.banner, "role_id", $$v)
                          },
                          expression: "banner.role_id",
                        },
                      }),
                    ],
                    1
                      ...
                      _c(
                        ...
                        [
                          _c("b-form-input", {
                            ...
                            model: {
                              value: _vm.banner.second_admin_name,
                              callback: function ($$v) {
                                _vm.$set(_vm.banner, "second_admin_name", $$v)
                              },
                              expression: "banner.second_admin_name",
                            },
                          }),
                        ],
                        1
                      ...
                      _c(
                        ...
                        [
                          _c("v-select", {
                            ...
                            model: {
                              value: _vm.banner.restaurant_id,
                              callback: function ($$v) {
                                _vm.$set(_vm.banner, "restaurant_id", $$v)
                              },
                              expression: "banner.restaurant_id",
                            },
                          }),
                        ],
                        1
                  ...
                  _c(
                    ...
                    [
                      _c("b-form-input", {
                        ...
                        model: {
                          value: _vm.banner.email,
                          callback: function ($$v) {
                            _vm.$set(_vm.banner, "email", $$v)
                          },
                          expression: "banner.email",
                        },
                      }),
                    ],
                    1
                  ...
                  _c(
                    ...
                    [
                      _c("b-form-input", {
                        ...
                        model: {
                          value: _vm.banner.password,
                          callback: function ($$v) {
                            _vm.$set(_vm.banner, "password", $$v)
                          },
                          expression: "banner.password",
                        },
                      }),
                    ],
                    1
              ...
              _vm._v(" "),
              _vm.Hidden ? _c("b-col", { attrs: { md: "6" } }) : _vm._e(),
              _vm._v(" "),
              _c(
                "b-col",
                [
...
/***/ "./resources/js/src/views/admin/roles/create_staff.vue":
/*!*************************************************************!*\
  !*** ./resources/js/src/views/admin/roles/create_staff.vue ***!
  \*************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _create_staff_vue_vue_type_template_id_61540a39__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./create_staff.vue?vue&type=template&id=61540a39 */ "./resources/js/src/views/admin/roles/create_staff.vue?vue&type=template&id=61540a39");
/* harmony import */ var _create_staff_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./create_staff.vue?vue&type=script&lang=js */ "./resources/js/src/views/admin/roles/create_staff.vue?vue&type=script&lang=js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _create_staff_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  _create_staff_vue_vue_type_template_id_61540a39__WEBPACK_IMPORTED_MODULE_0__["render"],
  _create_staff_vue_vue_type_template_id_61540a39__WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/src/views/admin/roles/create_staff.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/src/views/admin/roles/create_staff.vue?vue&type=script&lang=js":
/*!*************************************************************************************!*\
  !*** ./resources/js/src/views/admin/roles/create_staff.vue?vue&type=script&lang=js ***!
  \*************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_create_staff_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/babel-loader/lib??ref--4-0!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./create_staff.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/admin/roles/create_staff.vue?vue&type=script&lang=js");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_create_staff_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/src/views/admin/roles/create_staff.vue?vue&type=template&id=61540a39":
/*!*******************************************************************************************!*\
  !*** ./resources/js/src/views/admin/roles/create_staff.vue?vue&type=template&id=61540a39 ***!
  \*******************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_create_staff_vue_vue_type_template_id_61540a39__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../../node_modules/vue-loader/lib??vue-loader-options!./create_staff.vue?vue&type=template&id=61540a39 */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/src/views/admin/roles/create_staff.vue?vue&type=template&id=61540a39");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_create_staff_vue_vue_type_template_id_61540a39__WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_create_staff_vue_vue_type_template_id_61540a39__WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
