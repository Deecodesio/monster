...
class TransactionController extends BaseController
{
    ...
    public function Getpayout($type, Request $request)
    {
        ...
        return view('admin/payout', compact('type', 'data'));
    }
    ...
    public function Getpayout_history($type, Request $request)
    {
        ...
        if ($type == 'restaurant') {
            ...
            $data = $this->driver_payout_history->with('Deliverypartners')->get();
        }

        return view('admin/payout-history', compact('type', 'data'));
    }
    ...
    public function addpayment(Request $request)
    {
        ...
        $insert->save();
            ...
            return redirect('store/payout/' . $type)->with('success', trans('constants.paid_success_msg'));
