...
<body lang="en" link="#DD0000" vlink="#DD0000" class="emailify"
    style="mso-line-height-rule:exactly;word-spacing:normal;background-color:#fff;">
    <div class="bg" style="background-color:#ffffff;">
                                            ...
                                            <td align="center" class="x"
                                                ...
                                                <div style="text-align:center;">
                                                    <p style="Margin:0;text-align:center;"><span
                                                            style="font-size:28px;font-family:Inter,Arial,sans-serif;font-weight:700;color:#000000;line-height:114%;">{{$template[0]}}</span>
                                                    </p>
                                                </div>
                                            </td>
                                        </tr>
                                            ...
                                            <td align="left" class="x"
                                                ...
                                                <div style="text-align:left;">
                                                    <p style="Margin:0;text-align:left;"><span
                                                            style="font-size:16px;font-family:Inter,Arial,sans-serif;font-weight:700;color:#3c3c3c;line-height:150%;">{{$template[6]}}
                                                            {{$driver->name}},</span></p>
                                                    ...
                                                    <p style="Margin:0;"><span
                                                            style="font-size:16px;font-family:Inter,Arial,sans-serif;font-weight:700;color:#3c3c3c;line-height:150%;">{{$template[2]}}</span></p>
                                                    <p style="Margin:0;"><span
                                                            style="font-size:16px;font-family:Inter,Arial,sans-serif;font-weight:700;color:#3c3c3c;line-height:150%;">&nbsp;</span>
                                                    </p>
                                                    <p style="Margin:0;"><span
                                                            style="font-size:16px;font-family:Inter,Arial,sans-serif;font-weight:700;color:#3c3c3c;line-height:150%;"></span><span
                                                            style="font-size:16px;font-family:Inter,Arial,sans-serif;font-weight:400;color:#3c3c3c;line-height:150%;">{{$template[1]}}</span>
                                                    </p>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td align="center" vertical-align="middle" class="b  fw-1"
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" role="none"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td align="center" bgcolor="#00A082 " role="none"
                                                                style="border:none;border-radius:60px 60px 60px 60px;cursor:auto;mso-padding-alt:12px 0px 12px 0px;background:#00A082 ;"
                                                                valign="middle"> <a href="{{$url}}"
                                                                    style="display:inline-block;width:183px;background:#00A082 ;color:#ffffff;font-family:Inter,Arial,sans-serif;font-size:13px;font-weight:normal;line-height:100%;margin:0;text-decoration:none;text-transform:none;padding:12px 0px 12px 0px;mso-padding-alt:0;border-radius:60px 60px 60px 60px;"
                                                                    target="_blank"> <span
                                                                        style="font-size:14px;font-family:Inter,Arial,sans-serif;font-weight:700;color:#ffffff;line-height:121%;">{{$template[3]}} </span></a>
                                                            </td>
                                                            <td align="center" bgcolor="#00A082 " role="none"
                                                                style="border:none;border-radius:60px 60px 60px 60px;cursor:auto;mso-padding-alt:12px 0px 12px 0px;background:#00A082 ;"
                                                                valign="middle"> <a href="{{$url2}}"
                                                                    style="display:inline-block;width:183px;background:#00A082 ;color:#ffffff;font-family:Inter,Arial,sans-serif;font-size:13px;font-weight:normal;line-height:100%;margin:0;text-decoration:none;text-transform:none;padding:12px 0px 12px 0px;mso-padding-alt:0;border-radius:60px 60px 60px 60px;"
                                                                    target="_blank"> <span
                                                                        style="font-size:14px;font-family:Inter,Arial,sans-serif;font-weight:700;color:#ffffff;line-height:121%;">{{$template[7]}} </span></a>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="left" class="x"
                                                ...
                                                <div style="text-align:left;">
                                                    <p style="Margin:0;text-align:left;"><span
                                                            style="font-size:16px;font-family:Inter,Arial,sans-serif;font-weight:400;color:#777777;line-height:150%;">{{$template[4]}}</span></p>
                                                    <p style="Margin:0;"><span
                                                            style="font-size:16px;font-family:Inter,Arial,sans-serif;font-weight:400;color:#777777;line-height:150%;">{{$template[5]}}</span>
                                                    </p>
                                                </div>
                                            </td>
                                        </tr>
        ...
        <div class="r  pr-16 pl-16"
            style="background:#00A082 ;background-color:#00A082 ;margin:0px auto;max-width:600px;">
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="none"
                style="background:#00A082 ;background-color:#00A082 ;width:100%;">
                <tbody>
                    <tr>
                        <td style="border:none;direction:ltr;font-size:0;padding:16px 16px 16px 16px;text-align:left;">
                            <div class="xc568 ogf c"
                                            ...
                                            <td align="center" class="x"
                                                ...
                                                <div style="text-align:center;">
                                                    <p style="Margin:0;text-align:center;"><span
                                                            ...
                                                            &copy; {{date('Y')}} {{APP_NAME}}. All Rights Reserved.</span></p>
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
