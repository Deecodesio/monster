...
export default {
  ...
  methods:{
    changelang(lang){
      ...
      this.$http.get('/store/setlocale/'+lang)
              .then(res => {
  ...
  created() {
    this.$http.get('/store/setlocale_lang')
              .then(res => {
                this.$http.get('/store/setlocale/'+localStorage.getItem('lnags_store'))
              .then(res => {
      ...
      {
        this.$i18n.locale =  localStorage.getItem('lnags_store');  
