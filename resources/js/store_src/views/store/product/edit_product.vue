<template>
    <div>
        <validation-observer ref="simpleRules">
            <b-form @submit.prevent="addProduct">
                                ...
                                <b-row>
                                    ...
                                    <b-col md="6">
                                        <b-form-group :label="$t('category')">
                                            <v-select v-model="product.business_category_id"
                                                :options="this.bus_category" label="category_name"
                                                :reduce="(sel) => sel.id"
                            ...
                            <b-col lg="6" md="12" sm="12">
                                            ...
                                            <b-row>
                                                <b-col cols="4" v-for="(imageItem, index) in product.image" :key="index"
                                                    ...
                                                    <div class="imgcontainer">
                                                        <b-img thumbnail
                                                            :src="product.image[index] ? product.image[index] : '/no_image.png'"
                                                            rounded fluid style="width: 125%;padding: 1%"
                                ...
                                <b-col md="12" id="menu_list" v-if="layout_id == 1">
                                    <b-form-group :label="$t('menu')">
                                        <v-select v-model="product.menu_id" :options="this.menu" label="menu_name"
                                ...
                                <b-col md="12">
                                    <b-form-group :label="$t('status')">
                                        <v-select v-model="product.status" :options="options_status" label="text"
                    ...
                    <b-col lg="4" md="12" sm="12">
                        ...
                        <b-row class="mt-1">
                            <b-col md="12">
                                ...
                                <b-modal id="modal-center" centered :title="$t('Add New Attributes')" ok-only
                                    :ok-title="$t('Save')" ref="addon-modal" @ok="addon_add">
                                    <b-row>
                                        <b-col md="12">
                ...
                " v-model="naddon_name" />
                                        ...
                                        <b-col md="12">
                                            <b-form-group :label="$t('price')">
                                                <b-form-input id="name" :placeholder="$t('enter') + ' ' + $t('price')"
        ...
        <b-modal id="modal-xl" lazy scrollable title="Select Image" cancel-title="Close" size="xl"
                        ...
                        <b-row>
                            ...
                            <b-col md="12">
                                ...
                                <b-col md="12" style="display: flex;justify-content: center;margin-top: 20px;">
                                    <br />
                                    <b-button v-ripple.400="'rgba(255, 255, 255, 0.15)'" type="submit" variant="primary"
                                        class="mr-1" @click="cropImage" style=" display: none;" id="crop_btn">Crop
                                        Image</b-button>
                                    <b-button v-ripple.400="'rgba(255, 255, 255, 0.15)'" type="submit" variant="primary"
                                        class="mr-1" @click="rotate" style=" display: none;"
                                        id="rotate_btn">Rotate</b-button>
                                </b-col>
                            </b-col>
                        </b-row>
                    </div>
        ...
        addProduct() {
            this.$refs.simpleRules.validate().then(success => {
                if (success) {
                    ...
                    product1.append("business_category_id", this.product.business_category_id ? this.product.business_category_id : '');
                    product1.append("menu", this.product.menu_id ? this.product.menu_id : '');
    ...
    created() {
        ...
        this.$http
            ...
            .then((res) => {
                ...
                this.product.business_category = this.product.business_category_id
