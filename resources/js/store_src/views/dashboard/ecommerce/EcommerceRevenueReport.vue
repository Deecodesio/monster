    ...
    <b-row  class="match-height">
      ...
      >
        ...
        <vue-apex-charts
          ...
          :series="data[0].revenueReport[0].series"
        />
      </b-col>
    ...
    return {
      ...
      revenueReport: {
        chartOptions: {
          ...
          xaxis: {
            categories: [this.$t('Jan'), this.$t('Feb'), this.$t('Mar'), this.$t('Apr'),this.$t('May') , this.$t('Jun'), this.$t('Jul'),this.$t('Aug') ,this.$t('Sep') ,this.$t('oct') ],
