      ...
      <b-col cols="12" xl="9" md="8">
        <b-card no-body class="invoice-preview-card">
          ...
          <b-table-lite responsive :items="food_details"
            :fields="['image', 'Name', 'description', 'size', 'addons', 'quantity']">
...
export default {
  ...
  created() {
    ...
    this.$http.get('/admin/fetch_enquiry_order/' + this.$route.params.id)
      .then(res => {



        this.food_details = res.data.food
        this.req_details = res.data.request_details
