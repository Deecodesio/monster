        ...
        <b-form @submit.prevent="addBulkOrder">
            <b-row>
                ...
                <b-col md="6">
                    <b-form-group :label="$t('state')">
                        <b-form-input id="state" :placeholder="$t('select state')" v-model="bulkOrder.state"
            ...
            <b-row>
                <b-col md="6">
                    <b-form-group :label="$t('city')">
                        <b-form-input id="city" :placeholder="$t('select city')" v-model="bulkOrder.district"
                ...
                <b-col md="6">
                    <b-form-group :label="$t('taluk')">
                        <b-form-input id="taluk" :placeholder="$t('select taluk')" v-model="bulkOrder.taluk"
            ...
            <b-row>
                <b-col md="6">
                    <b-form-group :label="$t('phone_one')">
                        <b-form-input id="phone1" type="tel" :placeholder="$t('phone_one')" v-model="bulkOrder.phone_1"
            ...
            <!-- <b-row>
                <b-col md="6">
                    <b-form-group :label="$t('email')">
                        <b-form-input id="email" type="email" :placeholder="$t('email')" v-model="bulkOrder.email_id"
            ...
            <b-row>
                ...
                <b-col md="6">
                    ...
                    <b-form-group :label="$t('Shop place plan')">
                        <b-form-input id="Shop_place_plan" type="Shop_place_plan" :placeholder="$t('Shop place plan')"
                            v-model="bulkOrder.shop_location_plan" :required="!bulkOrder.shop_location_plan" />
                    </b-form-group>
                </b-col>
...
export default {
    ...
    methods: {
        addBulkOrder() {
            ...
            brand.append(
                "shop_location_plan",
                this.bulkOrder.shop_location_plan ? this.bulkOrder.shop_location_plan : ""
            );
    ...
    created() {
        ...
        if (this.$route.params.id) {
            this.$http.get('/api/franchises/' + this.$route.params.id)
                .then(res => {
