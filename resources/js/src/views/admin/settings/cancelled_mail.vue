<template>
    <div class="bg" style="background-color:#fff;">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td align="center" bgcolor="#80be3f" role="none"
                                                                ...
                                                                valign="middle" @click="edit_content('4', 'content4')">
                                                                <a style="display:inline-block;width:183px;background:#80be3f;color:#ffffff;font-family:Inter,Arial,sans-serif;font-size:13px;font-weight:normal;line-height:100%;margin:0;text-decoration:none;text-transform:none;padding:12px 0px 12px 0px;mso-padding-alt:0;border-radius:60px 60px 60px 60px;"
                                                                    target="_blank"> <span
        ...
        <div class="r  pr-16 pl-16"
            style="background:#E01764;background-color:#297b33;margin:0px auto;max-width:600px;">
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="none"
...
export default {
    ...
    methods: {
        ...
        save_content(content_name, file) {
            ...
            data.append('page', "cancelledordermail");
