<template>
    <div class="bg" style="background-color:#fff;">
                                         ...
                                         <tr>
                                             <td align="center" class="x" style="font-size:0;word-break:break-word;">
                                                 <div style="text-align:center;">
                                                     <p style="Margin:0;text-align:center;cursor:pointer" @click="edit_content('1','content1')"><span
                                                             style="font-size:28px;font-family:Inter,Arial,sans-serif;font-weight:700;color:#000000;line-height:114%;">{{content[1]}}</span>
                                                     </p>
                                                 </div>
                                             </td>
                                         </tr>
                                             ...
                                             <td align="left" class="x" style="font-size:0;word-break:break-word;">
                                                 <div style="text-align:left;">
                                                     <p style="Margin:0;text-align:left;"><span
                                                             style="font-size:16px;font-family:Inter,Arial,sans-serif;font-weight:700;color:#3c3c3c;line-height:150%;cursor:pointer" @click="edit_content('7','content7')">{{content[7]}}</span><span
                                                     ...
                                                     <p style="Margin:0;cursor:pointer" @click="edit_content('3','content3')"><span
                                                             style="font-size:16px;font-family:Inter,Arial,sans-serif;font-weight:700;color:#3c3c3c;line-height:150%;">{{content[3]}}</span></p>
                                                     <p style="Margin:0;"><span
                                                             style="font-size:16px;font-family:Inter,Arial,sans-serif;font-weight:700;color:#3c3c3c;line-height:150%;">&nbsp;</span>
                                                     </p>
                                                     <p style="Margin:0;cursor:pointer" @click="edit_content('2','content2')"><span
                                                             style="font-size:16px;font-family:Inter,Arial,sans-serif;font-weight:700;color:#3c3c3c;line-height:150%;"></span><span
                                                             style="font-size:16px;font-family:Inter,Arial,sans-serif;font-weight:400;color:#3c3c3c;line-height:150%;">{{content[2]}}</span>
                                                     </p>
                                                 </div>
                                             </td>
                                         </tr>
                                         ...
                                         <tr>
                                             <td align="center" vertical-align="middle" class="b  fw-1"
                                                 ...
                                                 <table border="0" cellpadding="0" cellspacing="0" role="none"
                                                     ...
                                                     <tbody>
                                                         <tr>
                                                             <td align="center" bgcolor="rgb(0 160 130)" role="none"
                                                                 style="border:none;border-radius:60px 60px 60px 60px;cursor:auto;mso-padding-alt:12px 0px 12px 0px;background:rgb(0 160 130);cursor:pointer"
                                                                 valign="middle" @click="edit_content('4','content4')"> <a 
                                                                     style="display:inline-block;width:183px;background:rgb(0 160 130);color:#ffffff;font-family:Inter,Arial,sans-serif;font-size:13px;font-weight:normal;line-height:100%;margin:0;text-decoration:none;text-transform:none;padding:12px 0px 12px 0px;mso-padding-alt:0;border-radius:60px 60px 60px 60px;"
                                                                     target="_blank"> <span
                                                                         style="font-size:14px;font-family:Inter,Arial,sans-serif;font-weight:700;color:#ffffff;line-height:121%;">{{content[4]}}</span></a>
                                                             </td>
                                                             <td align="center" bgcolor="rgb(0 160 130)" role="none"
                                                                 style="border:none;border-radius:60px 60px 60px 60px;cursor:auto;mso-padding-alt:12px 0px 12px 0px;background:rgb(0 160 130);cursor:pointer"
                                                                 valign="middle" @click="edit_content('8','content8')"> <a 
                                                                     style="display:inline-block;width:183px;background:rgb(0 160 130);color:#ffffff;font-family:Inter,Arial,sans-serif;font-size:13px;font-weight:normal;line-height:100%;margin:0;text-decoration:none;text-transform:none;padding:12px 0px 12px 0px;mso-padding-alt:0;border-radius:60px 60px 60px 60px;"
                                                                     target="_blank"> <span
                                                                         style="font-size:14px;font-family:Inter,Arial,sans-serif;font-weight:700;color:#ffffff;line-height:121%;">{{content[8]}}</span></a>
                                                             </td>
                                                         </tr>
                                                         <br>
                                                         <tr>
                                 ...
                                 <table border="0" cellpadding="0" cellspacing="0" role="none"
                                     ...
                                     <tbody>
                                         <tr>
                                             <td align="left" class="x" style="font-size:0;word-break:break-word;">
                                                 <div style="text-align:left;">
                                                     <p style="Margin:0;text-align:left;cursor:pointer"  @click="edit_content('5','content5')"><span
                                                             style="font-size:16px;font-family:Inter,Arial,sans-serif;font-weight:400;color:#777777;line-height:150%;">{{content[5]}}</span></p>
                                                     <p style="Margin:0;cursor:pointer"  @click="edit_content('6','content6')"><span
                                                             style="font-size:16px;font-family:Inter,Arial,sans-serif;font-weight:400;color:#777777;line-height:150%;">{{content[6]}}</span>
                                                     </p>
                                                 </div>
                                             </td>
                                         </tr>
         ...
         <div class="r  pr-16 pl-16"
             style="background:rgb(0 160 130);background-color:rgb(0 160 130);margin:0px auto;max-width:600px;">
             <table align="center" border="0" cellpadding="0" cellspacing="0" role="none"
                 style="background:rgb(0 160 130);background-color:rgb(0 160 130);width:100%;">
                 <tbody>
                     <tr>
                         <td style="border:none;direction:ltr;font-size:0;padding:16px 16px 16px 16px;text-align:left;">
                             <div class="xc568 ogf c"
         ...
         <b-modal id="modal-center" centered size="lg" hide-header hide-footer  ref="size-modal">
             ...
             <b-form-group :label="$t('Content')">
                 <b-form-textarea v-model="content[content_name]" id="textarea-default"
                     :placeholder="$t('Content')" rows="10" />
             </b-form-group>
                            
             <b-button v-ripple.400="'rgba(255, 255, 255, 0.15)'" @click="save_content(content_name,file)" variant="primary" class="mr-1">
                 {{ $t('save') }}
             </b-button>
     ...
     methods: {
         ...
         edit_content(content_name,file) {
             ...
             save_content(content_name,file){
                 ...
                 data.append('page', "driver_activation");
