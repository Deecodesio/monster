        ...
        <vue-good-table :columns="columns" :line-numbers="true" :rows="rows" :rtl="direction" :search-options="{
          ...
          <template slot="table-row" slot-scope="props">
            ...
            <span v-else-if="props.column.field === 'action'">
              ...
              <b-tooltip placement="left" :title="$t('edit category')" :target="`invoice-row-${props.row.id}-preview-icon`" />
  ...
  methods: {
    ...
    showMsgBoxTwo(id, res_name) {
      ...
      this.$bvModal
        ...
        .then(value => {
          if (value == true) {
            this.$http.get('/admin/delete_category/' + id)
              .then(res => {
    ...
    changedefault(id) {
      this.$http.get('/admin/category_status/' + id)
        .then(res => {
