    ...
    <b-col cols="12">
      <div>
        <form-wizard color="#7367F0" :title="null" :subtitle="null" shape="square" finish-button-text="Submit"
          ...
          <!-- accoint details tab -->
          <tab-content title="Driver Details" :before-change="validationForm">
            ...
            <validation-observer ref="accountRules" tag="form">
              ...
              <b-row>
                ...
                <b-col md="4">
                  <b-form-group label="Restaurant (Optional)" label-for="name">
                    <!-- <b-form-select
       ...
       <option
            ...
            >{{ userName.restaurant_name }}
                    ...
                    <v-select id="country" v-model="driver.restaurant" :options="this.rows" label="restaurant_name"
                      :reduce="sel => sel.id" placeholder="Select Restaurant"
                      :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'" />

                  </b-form-group>
                </b-col>
                <b-col md="4">
                  <b-form-group label="Vehicle Name*" label-for="email">

                    <b-form-select v-model="driver.vehicle_name">
                      <option value="" disabled>- Select Vehicle -</option>
                      <option v-for="vehicle1 in this.vehicles" :value="vehicle1.id" :key="vehicle1.vehicle_name">{{
                ...
                <b-col md="4">
                  <b-form-group label="Work City" label-for="password">
                    <b-form-select v-model="driver.city">
                      <option value="" disabled>- Select city -</option>
                      <option v-for="city in this.cities" :value="city.id" :key="city.city">{{ city.city }}
                      </option>
                    </b-form-select>
                  </b-form-group>
                </b-col>
                <b-col md="4">
                  <b-form-group label="Driver Name*">
                    ...
                    <validation-provider #default="{ errors }" name="drivername" rules="required">
                      <b-form-input id="name" v-model="driver.driver_name" :state="errors.length > 0 ? false : null"
                        placeholder="johndoe" />
                      <small class="text-danger">{{ errors[0] }}</small>
                    </validation-provider>
                  </b-form-group>
                ...
                <b-col md="4">
                  <b-form-group label="Phone No *">
                    <validation-provider #default="{ errors }" name="number" rules="required">
                      <b-form-input v-model="driver.phone_no" type="number" :state="errors.length > 0 ? false : null"
                ...
                <b-col md="4">
                  <b-form-group label="Work Area (Optional)">
                    <b-form-select v-model="driver.area">
                      <option value="" disabled>- Select area -</option>
                      <option v-for="areas1 in this.areas" :value="areas1.id" :key="areas1.city">{{ areas1.area }}
                      </option>
                    </b-form-select>
                  </b-form-group>
                </b-col>
                <b-col md="4">
                  <b-form-group label="Address Line 1*">
                    <validation-provider #default="{ errors }" name="Address" rules="required">
                      <b-form-input id="name" v-model="driver.address_line_1" :state="errors.length > 0 ? false : null"
                ...
                <b-col md="4">
                  <b-form-group label="Address Line 2">
                    <b-form-input id="name" v-model="driver.address_line_2" placeholder="Enter Address" />
                  </b-form-group>
                </b-col>
                <b-col md="4">
                  <b-form-group label="City*" label-for="c-password">
                    <validation-provider #default="{ errors }" name="City" rules="required">
                      <b-form-input v-model="driver.address_city" :state="errors.length > 0 ? false : null"
                ...
                <b-col md="4">
                  <b-form-group label="State/Province*" label-for="c-password">
                    <validation-provider #default="{ errors }" name="State" rules="required">
                      <b-form-input v-model="driver.state_province" :state="errors.length > 0 ? false : null"
                ...
                <b-col md="4">
                  <b-form-group label="Country*" label-for="c-password">
                    <validation-provider #default="{ errors }" name="Country" rules="required">
                      <b-form-input v-model="driver.country" :state="errors.length > 0 ? false : null"
                ...
                <b-col md="4">
                  <b-form-group label="Avatar *" label-for="c-password">
                    <b-form-file v-model="driver.profile_pic" class="mt-1" plain />
                  </b-form-group>
                </b-col>
                <b-col md="4">
                  <b-form-group label="Zip Code*" label-for="c-password">
                    <validation-provider #default="{ errors }" name="Zip Code" rules="required">
                      <b-form-input v-model="driver.zip_code" :state="errors.length > 0 ? false : null"
                ...
                <b-col md="4">
                  <b-form-group label="About" label-for="c-password">
                    <b-form-textarea v-model="driver.about" id="textarea" rows="3" placeholder="About.. " />
                  </b-form-group>
                </b-col>
                ...
                <b-col md="6">
                  <b-form-group label="License Front">

                    <b-form-file v-model="driver.license" class="mt-1" plain />
                  </b-form-group>
                </b-col>
                <b-col md="6">
                  <b-form-group label="GST">
                    <b-form-file v-model="driver.gst" class="mt-1" plain />
                  </b-form-group>
                </b-col>
                ...
                <b-col md="4">
                  <b-form-group label="Password" label-for="password">
                    <validation-provider #default="{ errors }" name="Password" vid="Password" rules="required|password">
                      <b-form-input id="password" v-model="driver.password" type="password"
                ...
                <b-col md="4">
                  <b-form-group label="Confirm Password" label-for="c-password">
                    <validation-provider #default="{ errors }" name="Password Confirm"
                      ...
                      <b-form-input id="c-password" v-model="passwordCon" type="password"
                        :state="errors.length > 0 ? false : null" placeholder="Re-type Password" />
                      <small class="text-danger">{{ errors[0] }}</small>
                    </validation-provider>
                  </b-form-group>
                </b-col>
                <b-col md="4">
                  <b-form-group label="Status*">
                    <b-form-select v-model="driver.status" :options="options" />
                  </b-form-group>
                </b-col>
          ...
          <tab-content title="Bank Details" :before-change="validationFormBank">
            <validation-observer ref="infoRules" tag="form">
              <b-row>
                ...
                <b-col md="6">
                  <b-form-group label="Account Name*">
                    <validation-provider #default="{ errors }" name="Account Name" rules="required">
                      <b-form-input v-model="driver_tab.account_name" placeholder="Enter Account Name"
                ...
                <b-col md="6">
                  <b-form-group label="Account Address*">
                    <validation-provider #default="{ errors }" name="Account Address" rules="required">
                      <b-form-input v-model="driver_tab.account_address" placeholder="Enter Account Address"
                        :state="errors.length > 0 ? false : null" />
                      <small class="text-danger">{{ errors[0] }}</small>
                    </validation-provider>
                  </b-form-group>
                ...
                <b-col md="6">
                  <b-form-group label="Account Number*">
                    <validation-provider #default="{ errors }" name="Account Number" rules="required">
                      <b-form-input v-model="driver_tab.account_no" placeholder="Enter Account Number"
                        :state="errors.length > 0 ? false : null" />
                      <small class="text-danger">{{ errors[0] }}</small>
                    </validation-provider>
                  </b-form-group>
                ...
                <b-col md="6">
                  <b-form-group label="Branch Address *">
                ...
                <b-col md="6">
                  <b-form-group label="Swift Code">
                    ...
                    <b-form-input v-model="driver_tab.swift_code" placeholder="Enter Swift Code" />
                ...
                <b-col md="6">
                  <b-form-group label="Routing Number">
                    ...
                    <b-form-input v-model="driver_tab.routing_no" placeholder="Enter Routing Number" />
