<template>
      ...
      >
        ...
        >
         ...
         <b-img
          ...
          />
          <b-img src="/no_image.png"    id="profile-img" fluid alt="Scan"  v-else/>
          ...
          <!-- Column: Action -->
            <span v-else-if="props.column.field === 'action'">
             <feather-icon
              ...
              class="mx-1"
              cursor="pointer"
              @click="$router.push({ name: 'edit_business', params: { id: props.row.id }})"
            />
            <b-tooltip
              placement="left"
              title="Edit Business"
  ...
  export default {
    ...
    created() {
      ...
      this.$http.get('/admin/business_lists1')
        .then(res => { 
          this.rows = res.data; 
          this.Loading = false;
    ...
    methods: {
      ...
      showMsgBoxTwo(id,res_name) {
          ...
          this.$bvModal
            ...
            .then(value => {
              if(value == true){
                          this.$http.get('/admin/delete_business/'+id)
                  .then(res => {    
        ...
        changedefault(id){
         this.$http.get('/admin/business_status/'+id)
          .then(res => {   
