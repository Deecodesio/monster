                                ...
                                <b-row>
                                    ...
                                    <!-- <b-col md="6" id="subcategory_list" v-if="layout_id != 1">
                                        <b-form-group :label="$t('subcategory')">
                                            <v-select v-model="product.category_id" :options="this.category"
                            ...
                            <b-col lg="6" md="12" sm="12">
                                <b-col md="12">
                                    ...
                                    <b-form-group :label="$t('Image')">
                                        ...
                                        <div v-if="productImage.length">
                                            <b-row>
                                                <!-- <b-col cols="4" v-for="(imageItem, index) in product.image" :key="index" -->
                                                <b-col
                                                    cols="4"
                                                    v-for="(
                                                        imageItem, index
                                            ...
                                            <b-list-group-item
                                                ...
                                                <b-col cols="12">
                                                    <b-row>
                                                        ...
                                                        <b-col cols="6" class="dotted" style="min-height: 40px;">
                                            ...
                                            <div v-if="fn.size_addon.length">
                                                <b-card v-if="tabIndex === 0">
                                                    <b-form ref="form" class="repeater-form"
                                                        ...
                                                        <b-row v-for="(item2, index2) in fn.size_addon" :id="item2.id"
                                                            :key="item2.id" ref="row">

                                                            <b-col md="3">
                                                                <b-form-group label="Variant"
                                                                    :label-for="'attribute' + index3">
                                                                    <b-form-input :id="'attribute' + index3" type="text"
                ...
                finalsizes[index].size_addon[index2].group_addons[index3].name
                                ...
                                <div>
                                    <b-form ref="form" class="repeater-form" @submit.prevent="repeateAgain">
                                        <b-row v-for="(item, index) in items" :id="item.id" :key="item.id" ref="row">
                                            <b-col md="3">
                                                <b-form-group label="Size" :label-for="'size' + index">
                                                    <v-select :id="'size' + index"
                                                        ...
                                                        :options="options" v-model="SelectedSize[index]">
                                                        <template #list-header>
                                            ...
                                            <b-col md="2">
                                                <b-form-group label="Price" :label-for="'food_price' + index">
                                                    <b-form-input :id="'food_price' + index" type="number"
                                                        placeholder="Price" v-model="SelectedPrice[index]" />
                                                </b-form-group>
                                            </b-col>
                                            <b-col md="4">
                                                <b-form-group label="Description" :label-for="'food_des' + index">
                                                    <b-form-input :id="'food_des' + index" type="text"
                                                        placeholder="Description" v-model="SelectedDesc[index]" />
                                                </b-form-group>
                                            </b-col>
                                            <b-col md="1">
                                                <b-form-group label="Default" :label-for="'default' + index">
                                                    <b-form-radio :id="'default' + index"
                                                        v-model="SelectedDefault[index]" name="default" :value=1>
                                            ...
                                            <b-col lg="2" md="3" class="mb-50">
                                                <b-button v-ripple.400="'rgba(40, 199, 111, 0.15)'"
                                                    variant="flat-success" class="btn-icon" style="margin-top: 10px;"
                            ...
                            <!-- <b-col cols="12" v-if="this.show === 1">
                                <b-button v-ripple.400="'rgba(255, 255, 255, 0.15)'" variant="primary"
                                    ...
                                    <span v-if="items.length">Add Sizes</span>
                                    <span v-if="!items.length">Multiple Sizes</span>
                                </b-button>
                                <b-button v-ripple.400="'rgba(255, 255, 255, 0.15)'" variant="primary"
                        ...
                        <div class="mb-3">
                            <b-tabs align="left" v-model="tabIndex">
                                ...
                                >
                                    ...
                                    >
                                        <b-list-group-item
                                            v-for="(listItem, index) in addons"
                                            :key="index"
                                            tag="li"
                                        >
                                            <div class="d-flex">
...
export default {
    ...
    computed: {
        allSelectedDistricts() {
            return this.productList.flatMap((p) => p.district || []);
        },
    },
    mounted() {
        this.initTrHeight();
    ...
    data() {
        return {
            ...
            p_status: 0,
            // layout_id: 1,
            layout_id: 0, // Temporary give us 0
            nextTodoId: 2,
            items_faq: [],
            nextTodoId_faq: 0,
            featured_image: 0,
    ...
    methods: {
        ...
        getAvailableDistricts(product) {
            return product.city_list.filter((dis) => {
                // Show this district if:
                // - It is NOT selected in other products OR7
                // - It IS already selected in this product
                return (
                    !this.allSelectedDistricts.includes(dis.id) ||
                    product.district.includes(dis.id)
                );
            });
        },
        update_sp(event) {
            if (this.product.split_payment == 1) {
                this.product.initial_price =
                    (this.product.price / 100) * this.split_value;
            }
        },
        calculate_ip(event) {
            ...
            if (this.product.split_payment == 1) {
                this.product.initial_price =
                    (this.product.bprice / 100) * this.split_value;
            }
        },
        repeateAgain_tb() {
            this.tables.push({
            ...
            this.$http
                ...
                .then((response) => {
                    if (response.data.status == true) {
                        this.$http
                            .get("/store/food_quantity/" + localStorage.id)
                            .then((res) => {
                                var names = [];
            ...
            this.$http
                ...
                .then((response) => {
                    if (response.data.status == true) {
                        ...
                        this.$http
                            .get("/store/category_list/" + this.user_info.id)
                            .then((res) => {
            ...
            this.$http
                ...
                .then((response) => {
                    if (response.data.status == true) {
                        ...
                        this.$http
                            .post("/store/menu_list", this.user_info)
                            .then((res) => {
            ...
            if (ind == 1) {
                ...
                this.$http
                    ...
                    .then((res) => {
                        ...
                        if (
                            this.addons_groups.length !== 0 &&
                            this.addons_groups.length > 5
                        ) {
                ...
                this.$http
                    ...
                    .then((res) => {
                        ...
                        if (
                            ...
                            this.addons.length > 5
                        ) {
                            document.getElementById("Simple_Attributes").style =
        ...
        addProduct() {
            this.$refs.simpleRules.validate().then((success) => {
                if (success) {
                    let productCopy = this.productList.map((item) => {
                        const { city_list, ...rest } = item;
                        return rest;
                    });
                    ...
                    product1.append(
                        ...
                        this.product.secondary_description
                            ? this.product.secondary_description
                            : ""
                    );
                    product1.append(
                    ...
                    // product1.append("category", this.product.category_id ? this.product.category_id : '');
                    product1.append(
                        "business_category_id",
                        this.product.business_category_id
                            ? this.product.business_category_id
                            : ""
                    );
                    product1.append(
                        "menu",
                        this.product.menu_id ? this.product.menu_id : ""
                    );
                    product1.append("status", this.product.status);
                    product1.append("stockstatus", this.product.out_of_stock);
                    ...
                    product1.append("image", JSON.stringify(this.productImage));
                    ...
                    product1.append("id", this.$route.params.id);
                    // product1.append('existing', JSON.stringify(this.product.existing));
                    product1.append(
                        "existing",
                        JSON.stringify(this.productExisting)
                    );
                    ...
                    product1.append("product", JSON.stringify(productCopy));
                    console.log("product1", productCopy);
                    [...product1.entries()].forEach(([key, value]) => {
                        console.log(`${key}:`, value);
                    });
                    const obj = Object.fromEntries(product1.entries());
                    console.log("product1 as JSON object:", obj);
                    console.log(
                        "product1 as JSON string:",
                        JSON.stringify(obj, null, 2)
                    );

                    this.$http
                        .post("/admin/add_to_product", product1)
                        .then((response) => {
                            if (response.data.status == true) {
                                this.$toast({
                                    component: ToastificationContent,
        ...
        repeateAgain(selectedItem) {
            ...
            var timer = setInterval(function () {
                if (document.getElementById("food_n" + i)) {
                    ...
                    document.getElementById("food_def" + i).value =
                        selectedItem;
                    clearInterval(timer);
                }
            }, 1000);
        },
        repeateAgain2(selectedItem) {
            this.items.push({
                id: (this.nextTodoId += this.nextTodoId),
            });
            this.$nextTick(() => {
        ...
        onTabChange(id) {
            if (id == 1) {
                ...
                document.getElementById("secondary_des").style.display =
                    "block";
            }
        },
        onChange(event) {
            this.$http
                .get(
                    "/store/category_list_one/" + event + "/" + localStorage.id
                )
                .then((res) => {
                    this.category = res.data;
                });
        ...
        async onStateChange(index) {
            const selectedStateId = this.productList[index].state;
            3;
            this.$http
                .get("/admin/city_list_by_state/" + selectedStateId)
                .then((res) => {
                    // this.city_list = res.data;

                    this.productList[index].city_list = res.data;
                    this.productList[index].district = [];
                });
        },

        removeProductPriceItem_table(index) {
    ...
    async created() {
        ...
        this.$http.get("/store/get_lang").then((res) => {
            this.setting1 = res.data;
        });
        this.user_info.id = localStorage.id;
        this.$http
            // .get("/store/edit_product_list/" + this.$route.params.id + '/' + this.user_info.id)
            .get("/admin/edit_product_list/" + this.$route.params.id)
            .then((res) => {
                this.product = res.data.product_list;
                this.productList = res.data.product_list.product;
                this.productImage = res.data.product_list.image;
                this.product.business_category =
                    this.product.business_category_id;
                this.product.food_type = this.product.is_veg;

                if (this.productList.length != 0) {
                    this.productList.forEach((product, index) => {
                        const stateId = product.state;

                        // Only fetch if stateId is present
                        if (stateId) {
                            this.$http
                                .get("/admin/city_list_by_state/" + stateId)
                                .then((cityRes) => {
                                    // Step 3: Inject city list into the product
                                    this.$set(
                                ...
                                .catch((err) => {
                                    console.error(
                                        "Failed to fetch city list for state ID",
                                        stateId,
                                        err
                                    );
                                    this.$set(
                            ...
                            this.$set(this.productList[index], "city_list", []); // fallback if no stateId
                        }
                        console.log("Open", this.productList[index]);
                    });
                } else {
                    this.productList = [
                        {
                ...
                console.log("product_List", res.data.product_list);
                console.log("productList", this.productList);
                // if (this.product.add_ons.length) {
                //     this.list3 = this.product.add_ons
                //     this.tabIndex = 0
                // } else if (this.product.groups.length) {
                //     this.tabIndex = 1
                //     this.list2 = this.product.groups
                // }
                // if (this.product.food_quantity.length) {
                //     this.show = 0
                //     this.finalsizes = this.product.food_quantity
                //     for (var i = 0; i < this.finalsizes.length; i++) {
                //         if (this.finalsizes[i].groups && this.finalsizes[i].groups.length) {
                //             this.tabIndex = 1
                //             this.finalsizes[i].size_addon = this.finalsizes[i].groups
                //         } else if (this.finalsizes[i].add_ons && this.finalsizes[i].add_ons.length) {
                //             this.tabIndex = 0
                //             this.finalsizes[i].size_addon = this.finalsizes[i].add_ons
                //         } else {
                //             this.finalsizes[i].size_addon = []
                //         }
                //     }
                // }
                // if (this.product.food_quantity.length) {
                //     this.items = this.product.food_quantity
                //     for (var i = 0; i < this.product.food_quantity.length; i++) {
                //         this.SelectedSize[i] = this.product.food_quantity[i]
                //         this.SelectedPrice[i] = this.product.food_quantity[i].price
                //         this.SelectedDesc[i] = this.product.food_quantity[i].size_description
                //     }
                // }
                ...
                //         this.product.existing[i] = 1
                //     }
                // }
                if (this.productImage.length) {
                    for (var i = 0; i < this.productImage.length; i++) {
                        this.productExisting[i] = 1;
                    }
                }
                this.items_pr = res.data.specs;
                this.items_faq = res.data.faq;

                this.tables = res.data.table;
            });
        // this.$http.get("/store/category_list/" + localStorage.id).then((res) => {
        //     this.category = res.data;
        // });
        ...
        this.user_info.id = localStorage.id;
        this.$http.post("/store/menu_list", this.user_info).then((res) => {
            this.menu = res.data.data;
        });
            ...
            .then((res) => {
                if (!this.list2.length) {
                    ...
                    if (
                        ...
                        document.getElementById("Grouped_Attributes").style =
                            "height: 300px;overflow: scroll;";
                    }
                } else {
