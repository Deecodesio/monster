...
export default {
    ...
    data() {
        return {
            ...
            content: `<h1 class="ql-align-center">Cancellation Policy`,
        }
    },
    directives: {
        Ripple,
    ...
    created() {
        ...
        this.$http.get('/admin/cancellation_policy')
            .then(res => {
    ...
    methods: {
        ...
        privacy_policy_add() {
            ...
            data.append('content_name', 'cancellation');

            this.$http.post('/admin/content_policy_cancel', data)
