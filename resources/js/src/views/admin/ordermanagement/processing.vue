<template>
  ...
  perPage: pageLength
          ...
          <template slot="table-row" slot-scope="props">
            <a id="link" hidden="hidden" target="_blank" href="/store/processing"></a>
            <!-- Column: Name -->
            ...
            <span v-else-if="props.column.field === 'action'">
              <span>
                <b-dropdown variant="link" toggle-class="text-decoration-none" no-caret>
                  ...
                  <b-dropdown-item @click="deliverd(props.row.id)">
                    <a> <i class="fa-solid fa-share"></i> {{ $t('delivery') }}</a>
                  </b-dropdown-item>
