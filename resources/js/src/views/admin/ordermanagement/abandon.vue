<template>
  ...
  perPage: pageLength
          ...
          <template slot="table-row" slot-scope="props">
            <a id="link" hidden="hidden" target="_blank" href="/store/abandon"></a>
            <!-- Column: Name -->
         ...
         <span v-if="props.row.delivery_type === 1">
          ...
          <span v-else>
            ...
            <span v-else-if="props.column.field === 'Action'">
              ...
              <b-tooltip placement="left" v-b-tooltip.hover.v-warning :title="'Login to ' + props.row.restaurant_name"
