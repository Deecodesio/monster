<template>
  ...
  perPage: pageLength
          ...
          <template slot="table-row" slot-scope="props">
            <a id="link" hidden="hidden" target="_blank" href="/store/cancelled"></a>
            ...
            <span v-else-if="props.column.field === 'Action'">
              ...
              <b-tooltip placement="left" :title="'Login to ' + props.row.restaurant_name"
            ...
            <span v-else-if="props.column.field === 'action'">
              <span>
                <b-dropdown variant="link" toggle-class="text-decoration-none" no-caret>
                  ...
                  <b-dropdown-item @click="make(props.row.id)" v-if="props.row.status === 11 || props.row.status === -1">
...
export default {
  components: {
    ...
    BCard,
    BTooltip,
    BModal, VBModal, BAlert, BImg, BMedia,
  },
  data() {
    return {
      pageLength: 10,
