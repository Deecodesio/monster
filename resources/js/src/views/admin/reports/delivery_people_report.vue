<template>
  ...
  perPage: pageLength
          ...
          <template slot="table-row" slot-scope="props">
            ...
            <div v-if="props.column.field === 'addresss'" class="text-nowrap">

              <span class="text-nowrap"> {{ props.row.address_line_1 }}</span>
            </div>
            ...
            <div v-if="props.column.field === 'rating'" class="text-nowrap">
              <b-form-rating no-border v-model="props.row.ratings" readonly variant="warning" inline precision="2" />
            </div>
            <!-- Column: Status -->
...
export default {
  ...
  this.$http.post('/admin/delivery_boy_reports',mail)
      .then(res => {
        this.rows = res.data;
        this.Loading = false;
