        ...
        >
          ...
          >
            <div class="alert-body font-small-2">
              <p>
                <small class="mr-50"><span class="font-weight-bold">Admin:</span> admin@deliware.app | 123456</small>
              </p>
              <!-- <p>
...
export default {
  ...
  data() {
    return {
      ...
      sideImg: require('@/assets/images/pages/food-bg.png'),
  ...
  computed: {
    ...
    imgUrl() {
      if (store.state.appConfig.layout.skin === 'dark') {
        ...
        this.sideImg = require('@/assets/images/pages/food-bg.png')
        return this.sideImg
      }
      return this.sideImg
    },
