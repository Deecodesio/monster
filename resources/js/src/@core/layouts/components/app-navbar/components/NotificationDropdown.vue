<template>
  ...
  >
    ...
    <li class="dropdown-menu-header">
      ...
      <label style="margin: auto; margin-right: 5%;font-weight: bold;">
        Sound
      </label>
     
        <b-form-checkbox
        :checked="notify_sound"
  ...
  created() {
    this.$http.get('/admin/get_neworder_alerts')
      .then(res => {
             ...
             var sound =   localStorage.notify_sound;
         
             if(sound != 0){
                this.notify_sound = true;
              }
              else
              {
