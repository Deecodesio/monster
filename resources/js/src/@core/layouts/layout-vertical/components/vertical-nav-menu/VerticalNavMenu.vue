      ...
      <slot name="header" :toggleVerticalMenuActive="toggleVerticalMenuActive" :toggleCollapsed="toggleCollapsed"
        ...
        <ul class="nav navbar-nav flex-row">
          ...
          <li class="nav-item mr-auto">
            <b-link class="navbar-brand" :to="{ name: 'dashboard-ecommerce' }">
              <span class="brand-logo">
                <b-img :src="rows[0].logo" alt="logo" v-if="isVerticalMenuCollapsed && !isMouseHovered" />
              </span>
              <span class="brand-text">
                <b-img :src="rows[0].logo_img" alt="logo" style="width: 175px;" />
              </span>
            </b-link>
          </li>
