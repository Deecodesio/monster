<template>
    <div class="pt-1" v-if="prop.length">
        <b-row>
            <b-col md="12">
                <div class="mb-2 mt-4" v-if="title == 'Top Selling Products'">
                    <h2 style="text-align: center">{{ title }}</h2>
                    <div class="hrLine" v-if="title != ''"></div>
                </div>
                <div class="mb-2" v-if="title == 'Best Seller'">
                    <h2>{{ title }}</h2>
