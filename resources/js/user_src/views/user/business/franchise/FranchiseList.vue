    ...
    <div v-else>
      ...
      <div class="banner-section mb-5">
        <b-card no-body class="text-center">
          <b-card-body class="py-5">
            <h1 class="display-4 mb-4">Become a Franchise Partner</h1>
            <p class="lead mb-4">Join our growing network of successful franchise partners across the country</p>
      ...
      <div id="apply-form" class="apply-form mt-5">
        ...
        <b-alert
          ...
          dismissible
        >
          Your franchise application has been submitted successfully! We will contact you soon.
        </b-alert>
...
export default {
  ...
  setup() {
    ...
    const submitApplication = async () => {
      // Validate form
      if (!nameState.value || !emailState.value || !phone1State.value || 
          !addressState.value || !stateState.value || !districtState.value || 
          !talukState.value || !pincodeState.value || !shopLocationState.value) {
        return
      }
      ...
      try {
        ...
        // await axios.post('/franchises', form.value) 
