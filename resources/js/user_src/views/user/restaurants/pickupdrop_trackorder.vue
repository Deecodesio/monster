                        ...
                        <b-row v-if="req_details" class="invoice-preview">
                            ...
                            <b-col cols="12" xl="12" md="12">
                                <b-card no-body class="invoice-preview-card">
                                    ...
                                    >
                                        <b-row class="invoice-spacing">
                                            ...
                                            <b-col xl="6" cols="12" class="p-0">
                                                ...
                                                <h6 class="mb-25">
                                                    {{
                                                        req_details.pickup_name
                                                    }}
                                                </h6>
                                                <p class="card-text mb-25">
                                                    {{ req_details.pickup_address }}
                                                </p>

                                                <p class="card-text mb-25">
                                                    {{ req_details.pickup_phone }}
                                                </p>
                                    ...
                                    >
                                        <template #cell(ItemsDescripton)="data">
                                           <b-row>
                                        ...
                                        <template #cell(price) ="data">
                                            <b-card-text class="text-nowrap">
                                                {{$store.state['defaults'].currency}}  {{ data.item.price }} 
                                            </b-card-text> 
                                                </template>
                                    </b-table-lite>
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                        {{$store.state['defaults'].currency}}   {{ req_details.delivery_charge }}
                                                        </p>
                                                    </div>
                                                    <div
                                                        class="invoice-total-item"
                                                    ...
                                                    >
                                                        ...
                                                        <p
                                                            class="invoice-total-amount"
                                                        >
                                                        {{$store.state['defaults'].currency}} {{  req_details.offer_discount }}
                                                        </p>
                                                    </div>
...
export default {
    ...
    methods: {
                ...
                var lat1 = this.orderstatus.user_lat; //rider lat
                var lng1 = this.orderstatus.user_lng;
                if(this.locations.length > 0)
                {
                    var lat2 = this.locations[0][1];
                    var lng2 = this.locations[0][2];
                }
                
                var rest_name = this.orderstatus.restaurant_name;
                var image = this.icons[0];
                var image1 = this.icons[1];
                var image2 = this.icons[2];
            ...
            lat_lng.push(new google.maps.LatLng(lat1, lng1));
