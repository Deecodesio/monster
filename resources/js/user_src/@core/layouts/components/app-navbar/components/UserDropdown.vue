<template>
  ...
  <div>
    ...
    <b-dropdown v-if="loggedin" v-ripple.400="'rgba(113, 102, 240, 0.15)'" variant="flat-success">
      <template #button-content>

        <b-avatar size="35" :src="profile_image" variant="light-primary" badge class="badge-minimal">
          <feather-icon v-if="!profile_image" icon="UserIcon" size="22" />
        </b-avatar>
      </template>
      ...
      <b-dropdown-item :to="{ name: 'profile' }">
        <i class="fa-solid fa-clipboard-list"></i> {{ $t("My Orders") }}
      </b-dropdown-item>
  ...
  <b-img src="/login.svg" fluid alt="Responsive image" />
          ...
          <b-form @submit.prevent="login">
            ...
            <b-form-group>
              <div class="d-flex justify-content-between">
                ...
                <small class="hoverme" @click="forgotpassoword()">{{ $t("Forgot Password") }}?</small>
              </div>
    ...
    <b-modal id="modal-vpass" cancel-variant="outline-secondary" hide-footer centered title="Forgot Password"
      ref="vpass">
    ...
    <b-modal id="modal-npass" cancel-variant="outline-secondary" hide-footer centered title="Reset Password"
      ref="npass">
            ...
            <b-form @submit.prevent="signup">
              ...
              <b-form-group>
                <validation-provider #default="{ errors }" name="Name" rules="required">
                  <label for="email1"> {{ $t("Name") }}</label>
                  <b-form-input id="email1" type="text" placeholder="Name" class="form-control-lg" v-model="signup_name"
              ...
              <b-form-group>
                <validation-provider #default="{ errors }" name="Email" rules="required|email">
                  <label for="email"> {{ $t("Email ID") }} </label>
                  <b-form-input id="email" type="email" placeholder="Email Address" class="form-control-lg"
                    v-model="signup_email" :state="errors.length > 0 ? false : null" />
                  <small class="text-danger">{{ errors[0] }}</small>
                </validation-provider>
              </b-form-group>
              <b-form-group>
          ...
          /> -->
              ...
              <b-form-group>
                <validation-provider #default="{ errors }" name="Password" vid="Password"
                  ...
                  <b-input-group class="input-group-merge">
                    <b-form-input id="password1" v-model="signup_password" :type="passwordFieldType"
                      class="form-control-merge" :state="errors.length > 0 ? false : null" name="login-password"
                      placeholder="Password" autocomplete="nope" />
