...
export default {
  pages: {
    ...
    data: [
      ...
      { title: 'New Orders', route: { name: 'new' }, icon: 'ArchiveIcon', isBookmarked: true },
      { title: 'User Management', route: { name: 'user_management' }, icon: 'UserIcon', isBookmarked: true },
      { title: 'Restaurants', route: { name: 'restaurant_list' }, icon: 'CoffeeIcon', isBookmarked: true },
      { title: 'City', route: { name: 'city_list' }, icon: 'MapIcon', isBookmarked: true },
      { title: 'vehicle', route: { name: 'vehicles_list' }, icon: 'TruckIcon', isBookmarked: false },
      { title: 'Brands', route: { name: 'brands_list' }, icon: 'BarChart2Icon', isBookmarked: false },
